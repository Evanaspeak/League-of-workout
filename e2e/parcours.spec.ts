...
/**
 * Écarte la modale d'accueil et la visite guidée si elles se présentent.
 *
...
async function passerIntro(page: Page) {
  ...
  for (const nom of [/passer.{0,6}introduction|skip.{0,6}introduction/i, /passer.{0,6}visite|skip.{0,10}tour/i]) {
