...
export const defis = {
  fr: {
    ...
    collectifAide: (n: number) => `Tout l'effort payé par tout le monde. ${n} personne${n > 1 ? "s" : ""} y a contribué ce mois-ci.`,
  ...
  es: {
    ...
    collectifAide: (n: number) => `Todo el esfuerzo pagado por todos. ${n} persona${n > 1 ? "s" : ""} ha contribuido este mes.`,
