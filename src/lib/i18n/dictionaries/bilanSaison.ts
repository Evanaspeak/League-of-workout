...
export const bilanSaison = {
  fr: {
    ...
    jourPlusGrosseDette: "Jour de la plus grosse dette",
  ...
  en: {
    ...
    jourPlusGrosseDette: "Day of the biggest debt",
  ...
  es: {
    ...
    jourPlusGrosseDette: "Día de la mayor deuda",
  ...
  de: {
    ...
    jourPlusGrosseDette: "Tag der größten Schuld",
  ...
  ja: {
    ...
    serie: "連続日数",
    joursActifs: "支払った日数",
    jourPlusGrosseDette: "負債が最も多かった日",
