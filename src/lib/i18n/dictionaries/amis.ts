...
export const amis = {
  fr: {
    ...
    recordsCercleTitre: "Parmi tes amis",
    ...
    equipeTotal: (formate: string) => `${formate} points dus en tout`,
    equipeDu: (formate: string, n: number) => (n === 0 ? "à jour" : `doit ${formate}`),
  ...
  en: {
    ...
    recordsCercleTitre: "Among your friends",
    ...
    equipeTotal: (formate: string) => `${formate} points owed in total`,
    equipeDu: (formate: string, n: number) => (n === 0 ? "clear" : `owes ${formate}`),
  ...
  es: {
    ...
    recordsCercleTitre: "Entre tus amigos",
    ...
    equipeTotal: (formate: string) => `${formate} puntos pendientes en total`,
    equipeDu: (formate: string, n: number) => (n === 0 ? "al día" : `debe ${formate}`),
  ...
  de: {
    ...
    recordsCercleTitre: "Unter deinen Freunden",
    ...
    equipeTotal: (formate: string) => `${formate} Punkte insgesamt offen`,
    equipeDu: (formate: string, n: number) => (n === 0 ? "ausgeglichen" : `schuldet ${formate}`),
  ...
  zh: {
    ...
    ajouter: "发送请求",
    envoi: "发送中…",
    envoyeeA: (pseudo: string) => colleCjk(`已向 ${pseudo} 发送请求。`),
    accepteeAvec: (pseudo: string) => colleCjk(`${pseudo} 之前已经请求过你：你们成为好友了。`),
    ...
    retirer: "移除",
    retirerConfirme: (pseudo: string) => colleCjk(`把 ${pseudo} 从好友中移除？`),
    ...
    copier: "复制",
    copierNomme: (nom: string) => colleCjk(`复制 ${nom} 的邀请码`),
    copie: "已复制",
    refaireCode: "换一个邀请码",
    refaireCodeAide: "旧的邀请码会立刻失效。如果邀请码传得太远，就换一个。",
    quitter: "退出",
    quitterConfirme: (nom: string) => colleCjk(`退出 ${nom}？`),
    quitterDernier: (nom: string) => colleCjk(`你是最后一名成员：退出 ${nom} 会把它删掉。`),
    proprietaire: "由你创建",
    ...
    recordsTitre: "纪录墙",
    recordsCercleTitre: "好友之间",
    recordsOuvertsTitre: "全站范围",
    recordsMois: "本月",
    recordsToujours: "全部时间",
    recordsLigne: (pseudo: string, formate: string, jourFormate: string) => colleCjk(`${pseudo}，${jourFormate} 偿还 ${formate} 点`),
    ...
    equipeVoir: "队伍的欠账",
    equipeVoirNomme: (nom: string) => colleCjk(`${nom} 队伍的欠账`),
    equipeTitre: "队伍欠账",
    equipeAide: "各尽所能。你为别人做的努力计入你的排名，同时抵消对方的欠账。",
    equipeTotal: (formate: string) => `共欠 ${formate} 点`,
    equipeDu: (formate: string, n: number) => (n === 0 ? "已还清" : `欠 ${formate}`),
    equipeRelayer: "承担",
    equipeRelayerNomme: (pseudo: string) => colleCjk(`承担 ${pseudo} 的一部分欠账`),
  ...
  ja: {
    ...
    ajouter: "申請を送る",
    envoi: "送信中…",
    envoyeeA: (pseudo: string) => colleCjk(`${pseudo} に申請を送りました。`),
    accepteeAvec: (pseudo: string) => colleCjk(`${pseudo} からすでに申請が届いていました。フレンドになりました。`),
    ...
    retirer: "外す",
    retirerConfirme: (pseudo: string) => colleCjk(`${pseudo} をフレンドから外しますか？`),
    ...
    copier: "コピー",
    copierNomme: (nom: string) => colleCjk(`${nom} の招待コードをコピー`),
    copie: "コピーしました",
    refaireCode: "コードを作り直す",
    refaireCodeAide: "古いコードはすぐに使えなくなります。コードが広まりすぎたときに使ってください。",
    quitter: "抜ける",
    quitterConfirme: (nom: string) => colleCjk(`${nom} から抜けますか？`),
    quitterDernier: (nom: string) => colleCjk(`あなたが最後のメンバーです。${nom} から抜けるとグループは削除されます。`),
    proprietaire: "あなたが作成",
    ...
    recordsTitre: "記録の壁",
    recordsCercleTitre: "フレンドのなかで",
    recordsOuvertsTitre: "アプリ全体",
    recordsMois: "今月",
    recordsToujours: "累計",
    recordsLigne: (pseudo: string, formate: string, jourFormate: string) => colleCjk(`${pseudo}、${jourFormate} に ${formate} ポイント`),
    ...
    equipeVoir: "チームの負債",
    equipeVoirNomme: (nom: string) => colleCjk(`${nom} のチームの負債`),
    equipeTitre: "チームの負債",
    equipeAide: "できる人ができる分だけ払います。誰かのために果たした努力はあなたのランキングに加算され、その人の負債を減らします。",
    equipeTotal: (formate: string) => `合計 ${formate} ポイントの未払い`,
    equipeDu: (formate: string, n: number) => (n === 0 ? "完済" : colleCjk(`${formate} の未払い`)),
    equipeRelayer: "引き受ける",
    equipeRelayerNomme: (pseudo: string) => colleCjk(`${pseudo} の負債の一部を引き受ける`),
