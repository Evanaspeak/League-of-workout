...
export const amis = {
  fr: {
    ...
    recordsLigne: (pseudo: string, points: number, jourFormate: string) => `${pseudo}, ${points} points le ${jourFormate}`,
  ...
  en: {
    ...
    recordsLigne: (pseudo: string, points: number, jourFormate: string) => `${pseudo}, ${points} points on ${jourFormate}`,
  ...
  es: {
    ...
    recordsLigne: (pseudo: string, points: number, jourFormate: string) => `${pseudo}, ${points} puntos el ${jourFormate}`,
  ...
  de: {
    ...
    recordsLigne: (pseudo: string, points: number, jourFormate: string) => `${pseudo}, ${points} Punkte am ${jourFormate}`,
  ...
  zh: {
    ...
    recordsLigne: (pseudo: string, points: number, jourFormate: string) => `${pseudo}，${jourFormate} 偿还 ${points} 点`,
  ...
  ja: {
    ...
    recordsMois: "今月",
    recordsToujours: "累計",
    recordsLigne: (pseudo: string, points: number, jourFormate: string) => `${pseudo}、${jourFormate} に ${points} ポイント`,
