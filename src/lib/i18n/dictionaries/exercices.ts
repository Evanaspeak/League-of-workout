export const exercices = {
  fr: {
    ...
    detteTitre: "À faire",
    detteVide: "Rien à faire. Va jouer.",
    detteSeuil: (t: string) => `Rappel à ${t} d'effort`,
    ...
    detteRappelCorps: (t: string) => `${t} d'effort en attente. C'est le moment.`,
    pompesNom: "Pompes",
  ...
  en: {
    ...
    detteTitre: "To do",
    detteVide: "Nothing owed. Go play.",
    detteSeuil: (t: string) => `Reminder at ${t} of work`,
    ...
    detteRappelCorps: (t: string) => `${t} of work waiting. Now's the time.`,
    pompesNom: "Push-ups",
