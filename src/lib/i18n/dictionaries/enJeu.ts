...
export const enJeu = {
  fr: {
    ...
    nonEnregistree: "Partie non enregistrée",
    partieNonLue: "Partie illisible",
  ...
  en: {
    ...
    nonEnregistree: "Match not logged",
    partieNonLue: "Match unreadable",
  ...
  es: {
    ...
    nonEnregistree: "Partida no registrada",
    partieNonLue: "Partida ilegible",
  ...
  de: {
    ...
    nonEnregistree: "Partie nicht eingetragen",
    partieNonLue: "Partie nicht lesbar",
