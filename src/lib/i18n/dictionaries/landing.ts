export const landing = {
  fr: {
    ...
    heroSubtitle: "Win or Workout transforme tes parties en effort physique. Chaque partie a un coût, calculé sur ta performance — et tu choisis comment tu le paies : pompes, squats ou boxe. Plus tu joues bien, moins tu paies.",
  ...
  en: {
    ...
    heroSubtitle: "Win or Workout turns your matches into physical effort. Every game has a cost, based on how you played — and you pick how you settle it: push-ups, squats or boxing. The better you play, the less you pay.",
