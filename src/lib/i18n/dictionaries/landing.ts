export const landing = {
  fr: {
    ...
    features: [
      ...
      { title: "Pompes, squats ou boxe", desc: "Choisis comment tu paies : la dette est convertie dans l'exercice qui te va. Sac ou shadow pour la boxe." },
      { title: "Rappel pendant la session", desc: "L'app te prévient dès que ta dette monte, pour la payer au fil de la soirée au lieu de tout cumuler à la fin." },
      { title: "Historique complet", desc: "Visualise ta dette par rôle, par champion, par période. Graphiques et stats." },
      { title: "App desktop", desc: "Application Windows pour un overlay discret pendant tes games." },
      { title: "Objectifs personnalisés", desc: "Définis ton objectif et suis ta progression semaine après semaine." },
    ],
  ...
  en: {
    ...
    features: [
      ...
      { title: "Push-ups, squats or boxing", desc: "Pick how you pay: your debt converts into whichever exercise suits you. Bag or shadow for boxing." },
      { title: "In-session reminder", desc: "The app nudges you as your debt builds, so you pay it off through the night instead of all at once." },
      { title: "Full history", desc: "See what you owe by role, champion, and period. Charts and stats included." },
      { title: "Desktop app", desc: "Windows app with a discreet overlay while you game." },
      { title: "Custom goals", desc: "Set your target and track your progress week after week." },
    ],
