export const landing = {
  ...
  es: {
    ...
    features: [
      ...
      { title: "Modo sesión", desc: "Cronómetro para los juegos por tiempo y seguimiento automático de las partidas de League en cuanto Riot nos abra la API." },
  ...
  de: {
    ...
    features: [
      ...
      { title: "Sitzungsmodus", desc: "Stoppuhr für Spiele nach Zeit und automatische Erfassung von League-Partien, sobald Riot uns die API öffnet." },
  ...
  zh: {
    ...
    features: [
      ...
      { title: "时段模式", desc: "为按时长的游戏计时；等 Riot 向我们开放 API，League 的对局就能自动追踪。" },
  ...
  ja: {
    ...
    features: [
      ...
      { title: "セッションモード", desc: "時間制のゲーム用のストップウォッチ。Riot が API を開放し次第、League の試合は自動で追跡します。" },
